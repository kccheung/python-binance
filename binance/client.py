...
class Client(BaseClient):
    ...
    def get_margin_account_repay(self, **params):
        """Cross Margin Account Transfer (MARGIN)
        ...
        .. code:: python
            ...
            result = client.get_margin_account_repay(asset='BTC', amount=0.5)
...
class AsyncClient(BaseClient):
    ...
    async def get_margin_account_borrow(self, **params):
        return await self._request_margin_api('post', 'margin/loan', True, data=params)

    get_margin_account_borrow.__doc__ = Client.get_margin_account_borrow.__doc__

    async def get_margin_account_repay(self, **params):
        return await self._request_margin_api('post', 'margin/repay', True, data=params)

    get_margin_account_repay.__doc__ = Client.get_margin_account_repay.__doc__
